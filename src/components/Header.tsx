...
export function Header() {
  ...
  // Removed unused subsidiaries array

  // Removed unused aboutItems array

  // Removed unused loginOptions array

  // Removed unused moreOptions array

  // Mega Menu Structure for Demo Pages
  // Removed unused megaMenuCategories array
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="relative">
              <button
                ...
                className="text-sm cursor-pointer font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50 flex items-center gap-1"
              >
                PAYMENT SOLUTIONS
            ...
            <div className="relative">
              <a
                href="/rfp"
                className="text-sm cursor-pointer font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-50"
              >
                FAQs
              </a>
            </div>
